                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('provider') is-invalid @enderror"
                                    ...
                                    <option value="aws" {{ old('provider', $server->provider) == 'aws' ? 'selected' : '' }}>AWS</option>
                                    <option value="digitalocean" {{ old('provider', $server->provider) == 'digitalocean' ? 'selected' : '' }}>DigitalOcean</option>
                                    <option value="vultr" {{ old('provider', $server->provider) == 'vultr' ? 'selected' : '' }}>Vultr</option>
                                    <option value="other" {{ old('provider', $server->provider) == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('provider')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('cpu_cores') is-invalid @enderror"
                                       id="cpu_cores" name="cpu_cores" value="{{ old('cpu_cores', $server->cpu_cores) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('ram_mb') is-invalid @enderror"
                                       id="ram_mb" name="ram_mb" value="{{ old('ram_mb', $server->ram_mb) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('storage_gb') is-invalid @enderror"
                                       id="storage_gb" name="storage_gb" value="{{ old('storage_gb', $server->storage_gb) }}"
